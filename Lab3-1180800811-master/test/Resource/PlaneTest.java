...
public class PlaneTest {
	...
	public void EqualsTest() {
		...
		plane1.setMachineNumber(null);//覆盖:this.age == null 
		plane1.setAge(10);
		assertFalse(plane1.equals(plane2)) ;//覆盖：this.age != other.age 
		plane1.setAge(10.5);
		assertFalse(plane1.equals(plane2));//覆盖:this.MachineNumber == null ,other.MachineNumber != null
		...
		plane1.setPlaneNumber(null);
		assertFalse(plane1.equals(plane2));//覆盖:this.PlaneNumber == null ,other.PlaneNumber != null
