...
public abstract class MultipleSortedResourceEntryTest {
	...
	public void setResourceTest() {
		...
		res.setResource(null);//¸²¸Ç: r == null
		System.out.println(res.getResource() == null );
		assertTrue(res.getResource() != null );
	}
	...
	public void addResourceTest() {
		...
		res.addResource(null);//¸²¸Ç:resource == null,r != null
		assertTrue(res.getResource().contains(railway));
		assertTrue(res.getResource().size() == 1) ;
	}
	...
	public void deleteResourceTest() {
		...
		res.deleteResource(null);//¸²¸Ç:resource == null
