...
public class CANCELLEDTest {
	/*
	 * Testing strategy :
	 * 	只需要测试CANCELLED状态到其他状态的转换、toString方法和accept方法即可
	 */
	...
	/*
	 * 覆盖:状态CANCELLED状态向ALOCATED的状态的转换
	 */
	...
	/*
	 * 覆盖:状态CANCELLED状态向CANCELLED的状态的转换
	 */
	@Test(expected= IllegalArgumentException.class)
	public void Test2() {
		State state= CANCELLED.instance ;
	...
	/*
	 * 覆盖:状态CANCELLED状态向BLOCKED的状态的转换
	 */
	@Test(expected= IllegalArgumentException.class)
	public void Test3() {
		State state= CANCELLED.instance ;
	...
	/*
	 * 覆盖:状态CANCELLED状态向RUNNING的状态的转换
	 */
	@Test(expected= IllegalArgumentException.class)
	public void Test4() {
		State state= CANCELLED.instance ;
