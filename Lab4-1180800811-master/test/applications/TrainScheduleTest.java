...
public class TrainScheduleTest {
	...
	public void cancelPlaningEntryTest() throws ParseException, cancelPlanningEntryException {
		...
		try {
			t.cancelPlanningEntry(name, s1.getdate1()).equals("高铁当前状态为CANCELLED,不能取消");
		}catch( cancelPlanningEntryException e) {
			assertEquals("取消计划项异常: 计划项tt当前的状态不允许取消" ,e.getMessage());
		}
	...
	public void BeginPlanningEntryTest() throws feipeiResourceException, ParseException {
		...
		t.board(new Location("哈尔滨"), s1.getdate1(), 0);
		t.show(new Location("哈尔滨"), s1.getdate1());
	}
	...
	public void deleteLocationTest() throws deleteLocationException, deleteResourceException, ParseException, feipeiResourceException {
		...
		assertFalse(c.deleteResource("aa", "一等", 30, 2019));//待删除的资源不存在
		assertFalse(c.deleteResource("aa", "二等", 30, 2019));//待删除的资源不存在
		assertFalse(c.deleteResource("aa", "软卧", 30, 2019));//待删除的资源不存在
		assertFalse(c.deleteResource("aa", "硬卧", 30, 2019));//待删除的资源不存在
		assertFalse(c.deleteResource("aa", "硬座", 30, 2019));//待删除的资源不存在
		assertFalse(c.deleteResource("aa", "行李车", 30, 2019));//待删除的资源不存在
		assertFalse(c.deleteResource("aa", "餐车", 30, 2019));//待删除的资源不存在
		c.addResource("aa", "商务", 30, 2019);
		c.addResource("aa", "一等", 30, 2019);
		c.addResource("aa", "二等", 30, 2019);
		c.addResource("aa", "软卧", 30, 2019);
		c.addResource("aa", "硬卧", 30, 2019);
		c.addResource("aa", "行李车", 30, 2019);
		c.addResource("aa", "餐车", 30, 2019);
		Timeslot s1 = new Timeslot() ; 
		s1.setDate1("2020-03-21 10:20");
		s1.setDate2("2020-03-21 17:20");
		assertTrue(c.deleteResource("aa", "一等", 30, 2019));//待删除的资源存在]
		...
		try {
			...
			assertEquals("删除位置异常: 有尚且未结束的计划项在位置:Nan执行" ,e.getMessage());
		}
	...
	public void deleteResourceTest() throws deleteResourceException, ParseException, feipeiResourceException {
		...
		c.BeginPlanningEntry("s", s1.getdate1());
		try {
			c.deleteResource("aa", "商务", 30, 2019);
		}catch(deleteResourceException e) {
			assertEquals("删除资源异常: 有尚未结束的计划项正在使用该资源:Railway [Number=aa, type=BUSINESS, Size=30, Year=2019]",e.getMessage());
		}
	...
	public void getPrePlanningEntryTest() throws Exception {
		...
		assertFalse(t.getPrePlanningEntry("aa", "一等", 30, 2019, name1, s11.getdate1()));
		assertFalse(t.getPrePlanningEntry("aa", "二等", 30, 2019, name1, s11.getdate1()));
		assertFalse(t.getPrePlanningEntry("aa", "软卧", 30, 2019, name1, s11.getdate1()));
		assertFalse(t.getPrePlanningEntry("aa", "硬卧", 30, 2019, name1, s11.getdate1()));
		assertFalse(t.getPrePlanningEntry("aa", "硬座", 30, 2019, name1, s11.getdate1()));
		assertFalse(t.getPrePlanningEntry("aa", "餐车", 30, 2019, name1, s11.getdate1()));
		assertFalse(t.getPrePlanningEntry("aa", "行李车", 30, 2019, name1, s11.getdate1()));
		t.getResourcePlanningEntry("aa", "商务", 30, 2019, s11.getdate1());
		t.getResourcePlanningEntry("aa", "一等", 30, 2019, s11.getdate1());
		t.getResourcePlanningEntry("aa", "二等", 30, 2019, s11.getdate1());
		t.getResourcePlanningEntry("aa", "软卧", 30, 2019, s11.getdate1());
		t.getResourcePlanningEntry("aa", "硬卧", 30, 2019, s11.getdate1());
		t.getResourcePlanningEntry("aa", "硬座", 30, 2019, s11.getdate1());
		t.getResourcePlanningEntry("aa", "餐车", 30, 2019, s11.getdate1());
		t.getResourcePlanningEntry("aa", "行李车", 30, 2019, s11.getdate1());
