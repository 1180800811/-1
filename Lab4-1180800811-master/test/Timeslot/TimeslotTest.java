...
public class TimeslotTest {
	...
	public void getdate1Test() {
		...
		s2.set(2020, 5 - 1, 26);//预期的时间
		Calendar t = s.getdate1();
		assertTrue(t.equals(s1));//判断预期的时间和得到的时间是否相等
	}
	...
	public void getdate2Test() {
		Timeslot s = new Timeslot() ;
		Calendar s1 = Calendar.getInstance() ; 
		s1.set(2021, 4 -1, 26);//设定时间
		s.setdate2(s1);
		Calendar s2 = Calendar.getInstance() ; 
		s2.set(2021, 4 - 1, 26);//预期的时间
	...
	public void getDate2() {
		Timeslot s = new Timeslot() ;
		Calendar s2 = Calendar.getInstance() ; 
		s2.set(2021, 4-1, 26, 9, 16, 23);//设定时间
		s.setdate2(s2);
		assertTrue(s.getDate2().equals("2021-04-26 09:16"));//判断预期的结果和得到的表示时间的字符串是否相等
	}
	...
	public void setDate2Test1() throws ParseException {
		Timeslot s = new Timeslot() ;
		String s2 = "2021-04-26 09:16" ;//符合"yyyy-MM-dd HH:mm"格式的字符串
	...
	public void setdate2Test() throws ParseException {
		Timeslot s = new Timeslot() ;
		Calendar s1 = Calendar.getInstance() ;
		s1.set(2021, 4 -1, 26,9,16,32);
		s.setdate2(s1);//设定时间
		String s2 = "2021-04-26 09:16" ;//预期结果
		assertTrue(s.getDate2().equals(s2));//判断预期结果和得到的结果是否相同
	}
