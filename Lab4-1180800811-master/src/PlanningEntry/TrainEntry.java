...
public class TrainEntry extends CommonPlanningEntry<Railway> implements TrainPlanningEntry<Railway> {
	...
	//AF:
	// Representing a TrainEntry that has multiple locations and multiple resources and multiple time
	//
	//PI:
	//mle != null , be != null , msre != null 
	//
	//Rep:
	// all fields is private and there is no exposure of the fields
	//
